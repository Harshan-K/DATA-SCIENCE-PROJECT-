# Traffic And Accident AI Detection System ⚠️🚗💥
...
- 🎯 **High Accuracy** with confidence threshold filtering
- 📁 **Multiple File Formats** (Images: JPG, PNG, GIF | Videos: MP4, AVI, MOV)
